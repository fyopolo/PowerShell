...
$AllUsersInDomain = Get-ADObject -Filter {(objectClass -eq "user") -and (objectCategory -eq "user")} -Properties * -SearchBase $Domain.distinguishedName -SearchScope Subtree
$Array = @()

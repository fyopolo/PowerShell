<# Execute-AWRestAPI Powershell Script Help
  ...
  .PARAMETER endpointURL
    ...
    Old API URI: https://host/api/v1/mam/apps/public/{applicationid}/addsmartgroup/{smartgroupid}
    New API URI: https://host/api/mam/apps/public/{applicationid}/smartgroup/{smartgroupid}

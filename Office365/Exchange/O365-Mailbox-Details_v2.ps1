...
$Mailboxes = Get-Mailbox * -ResultSize unlimited |
    ...
    ## REPORT ##
    #$rpt += Get-HtmlContentOpen -HeaderText "Mailboxes" -IsHidden
    ...
    $rpt += Get-HtmlContentTable $Mailboxes -GroupBy ("Recipient Type Details")	
#$rpt += Get-HTMLContentText -Heading "$tabarray.Item(0)" -Detail $Mailboxes #-GroupBy ("Recipient Type Details")
...
foreach ($O365Group in $O365Groups)  
        {  
            ...
            # $Members | Select -Property @{n='Name';e={$_.Name}},
            # @{n='Primary SMTP Address';e={$_.PrimarySmtpAddress}}

            # $O365Group | Select -Property @{n='Owner';e={$_.ManagedBy}},
            #    @{n='Display Name';e={$_.DisplayName}},
            #    @{n='Primary SMTP Address';e={$_.PrimarySmtpAddress}},
            #    @{n='Email Addresses';e={$_.EmailAddresses}}

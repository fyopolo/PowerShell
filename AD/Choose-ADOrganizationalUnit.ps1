...
function Choose-ADOrganizationalUnit {
    ...
    function Change-Forest 
    {
	    ...
	    $labelUsernamePassword.Text = "Username Password"
	    #
	    # tb_DCName
	    #
    ...
    $formChooseOU.Controls.Add($buttonCANCEL)
	$formChooseOU.AcceptButton = $buttonOK
    $formChooseOU.CancelButton = $buttonCANCEL
...
$Path = Choose-ADOrganizationalUnit -WindowTitle "Chose Search Base OU" -ErrorAction SilentlyContinue
$Exclusion = Choose-ADOrganizationalUnit -WindowTitle "Chose EXCLUSION OU" -ErrorAction SilentlyContinue
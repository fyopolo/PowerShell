# -------------------------------------------------------------------------------
# Script: AD-BuklContactCreation.PS1
# Author: Fernando Yopolo
# Date: 06/16/2017
# Comments: Create Active Directory contacts from a CSV file
# Comments: CSV file must be saved using UTF-8 Encoding (do not modify column names)
# -------------------------------------------------------------------------------
...
# Load information and create array
$Users = Import-Csv -Path $CSVFile


# Destination OU for object creation
# $Path = "OU=External-Contacts,OU=MyBusiness,DC=jmg,DC=local"
...
# Maping each file property with LDAP properties
 ...
 ForEach ($User in $Users) {
    ...
    # Object creation
    New-ADObject -Type Contact -Name $name -Path $Path -OtherAttributes @{'displayName'=$Name;'mail'=$mail;'givenName'=$GivenName;'sn'=$Surname;'telephoneNumber'=$Phone}
}
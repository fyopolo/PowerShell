...
$SiteURL="https://nahq.sharepoint.com/"
$UserAccount="i:0#.f|membership|brightkey@nahq.org"
...
Try {
        ...
        Connect-SPOService -Url https://nahq-admin.sharepoint.com -credential $Cred

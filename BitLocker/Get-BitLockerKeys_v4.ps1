...
# $BLStatus | Out-File -FilePath "C:\TEMP\BicLotkerStat_$($env:COMPUTERNAME).txt"
# $BLStatus | Export-Csv -Path "C:\TEMP\BicLotkerStat_$($env:COMPUTERNAME).csv" -NoTypeInformation